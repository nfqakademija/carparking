 ...
 */
final class Version20191129175818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, park_space_id INT DEFAULT NULL, reservation_date DATETIME NOT NULL, INDEX IDX_4DA239A76ED395 (user_id), INDEX IDX_4DA23962A00C5A (park_space_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
