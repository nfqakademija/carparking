 ...
 */
final class Version20191214005135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notifications (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guest_id INT DEFAULT NULL, accepted SMALLINT NOT NULL, delivered SMALLINT NOT NULL, request_start_date DATETIME NOT NULL, request_end_date DATETIME NOT NULL, INDEX IDX_6000B0D3A76ED395 (user_id), INDEX IDX_6000B0D39A4AA658 (guest_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, user_role_id INT DEFAULT NULL, permanent_space_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, licence_plate VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_1483A5E98E0E3CA6 (user_role_id), UNIQUE INDEX UNIQ_1483A5E98C6678E9 (permanent_space_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notifications ADD CONSTRAINT FK_6000B0D39A4AA658 FOREIGN KEY (guest_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY FK_6000B0D39A4AA658');
